...
//$connect=mysqli_connect('localhost',"eventapn_version1","JZ2dCrcN6GJKnn7","eventapn_version1");
...
function lockTableForWrite($tablename)
{
    //LOCK TABLES tablename WRITE;
    //LOCK TABLES tablename WRITE,table2 READ;
    $sql='LOCK TABLES '.$tablename;
    querySend($sql);
}
